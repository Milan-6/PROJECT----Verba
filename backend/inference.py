...
Commit logic (protects the live demo):
  ...
  * average the last 3 probability vectors
  * a gloss becomes a *candidate* only if it is not NONE, its averaged prob > THRESH,
    and it has been the arg-max for 2 consecutive windows (~0.3 s)
...
STRIDE, THRESH, CONSEC, REFRACTORY_S, SMOOTH = 5, 0.75, 2, 0.6, 3
