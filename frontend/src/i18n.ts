...
const en = {
  ...
  micStop: 'Stop', presets: 'Quick phrases', shownToDeaf: 'Shown to the Deaf person', glossLabel: 'ISL order',
...
const hi: typeof en = {
  ...
  micStop: 'रोकें', presets: 'त्वरित वाक्य', shownToDeaf: 'बधिर व्यक्ति को दिखाया गया', glossLabel: 'ISL क्रम',
